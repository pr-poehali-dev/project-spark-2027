...
export default function Footer() {
  return (
    <footer className="text-white mt-auto" style={{ background: "hsl(210 70% 35%)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Профессиональный ремонт бытовой техники любых брендов. Выезд мастера в день обращения.
            </p>
          </div>
